...
function onYouTubeInfoReceived(songRequest) {
  ...
  console.log('name', songRequest.youtube_matches.constructor.name)
  console.log('name [0]', songRequest.youtube_matches[0].constructor.name)
  db.updateSongRequestWithID(songRequest.id, { youtube_matches: songRequest.youtube_matches,
